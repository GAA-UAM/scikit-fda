...
# target. In this case, it includes the different climates to which the
# weather stations belong to.
...
# consequence, this measure detects better shape outliers compared to the
# previous one.
