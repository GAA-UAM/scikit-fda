...
from typing import Any, Tuple, TypeVar  # noqa: UP035

import multimethod
import numpy as np

from ...typing._numpy import NDArrayFloat  # noqa: TC001
from .._functional_data import FData  # noqa: TC001
from ..grid import FDataGrid  # noqa: TC001
from ._basis import Basis
from ._fdatabasis import FDataBasis  # noqa: TC001
...
class CustomBasis(Basis):
    ...
    def _check_linearly_independent(self, fdata: FData) -> None:  # noqa: ARG002
        raise ValueError("Unexpected type of functional data object.")  # noqa: EM101, TRY003
    ...
    def _check_linearly_independent_matrix(self, matrix: NDArrayFloat) -> None:
        ...
        if matrix.shape[0] > matrix.shape[1]:
            raise ValueError(  # noqa: TRY003
                "There are more functions than the maximum dimension of the "  # noqa: EM101
        ...
        if rank != matrix.shape[0]:
            raise ValueError(
                "There are only {rank} linearly independent "  # noqa: EM103, UP032
                "functions".format(
                    rank=rank,
                ),
            )
    ...
    @multimethod.multidispatch
    def _create_subspace_basis_coef(  # noqa: PYI019
        self: T,
        fdata: FData,
        coefs: np.ndarray,  # noqa: ARG002
    ) -> Tuple[T, NDArrayFloat]:  # noqa: UP006
        """
        ...
        """
        raise ValueError(
            "Unexpected type of functional data object: {type}.".format(  # noqa: EM103, UP032
                type=type(fdata),
            ),
        )

    @_create_subspace_basis_coef.register
    def _create_subspace_basis_coef_grid(  # noqa: PYI019
        self: T,
        fdata: FDataGrid,
        coefs: np.ndarray,
    ) -> Tuple[T, NDArrayFloat]:  # noqa: UP006
    ...
    @_create_subspace_basis_coef.register
    def _create_subspace_basis_coef_basis(  # noqa: PYI019
        self: T,
        fdata: FDataBasis,
        coefs: np.ndarray,
    ) -> Tuple[T, NDArrayFloat]:  # noqa: UP006
    ...
    def __ne__(self, other: Any) -> bool:  # noqa: ANN401, PYI032
        return not self.__eq__(other)

    def __repr__(self) -> str:
        """Representation of a CustomBasis object."""
        return "{super}, fdata={fdata}".format(  # noqa: UP032
