...
The examples
:ref:`sphx_glr_auto_examples_representation_plot_irregular_to_basis_mixed_effects.py` and
:ref:`sphx_glr_auto_examples_representation_plot_irregular_mixed_effects_robustness.py`
