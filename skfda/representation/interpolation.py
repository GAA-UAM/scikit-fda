...
# Scipy interpolation methods used internally
class SplineInterpolation(EvaluatorConstructor):
    ...
    def evaluator(self, fdatagrid):
        """Construct a SplineInterpolationEvaluator used in the evaluation.
        ...
        Returns:
            (:class:`SplineInterpolationEvaluator`): Evaluator of the fdatagrid.

        """
        return SplineInterpolationEvaluator(fdatagrid, self.interpolation_order,
...
class SplineInterpolationEvaluator(Evaluator):
    r"""Spline interpolation evaluator of :class:`FDataGrid`.

    It is generated by the SplineInterpolation, and it is used internally
    ...
    def __init__(self, fdatagrid, k=1, s=0., monotone=False):
        r"""Constructor of the SplineInterpolationEvaluator.
