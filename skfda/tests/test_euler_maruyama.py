...
def test_one_initial_point() -> None:
    ...
    expected_result = np.array([[[0.], [0.81217268],
                                 [0.50629448], [0.2422086],
                                 [-0.29427571]],
                                [[0.], [0.43270381],
                                    [-0.71806553], [0.15434035],
                                    [-0.2262631]]])
...
def test_initial_data_generator() -> None:
    ...
    # standard_normal_generator = random_state.standard_normal
    random_state = np.random.RandomState(1)
    ...
    expected_result = np.array([[[1.62434536],
                                 [1.36025949],
                                 [0.82377518],
                                 [1.25647899],
                                 [0.10570964]],
    ...
    expected_result = np.array([[[1.62434536, -0.61175641],
...
def test_initial_distribution() -> None:
    ...
    rvs method
        Tests:
            - initial_condition = scipy.stats.norm, n_samples = 2
            - initial_condition = scipy.stats.multivariate_norm,
                n_samples = 2.
    """
    # random_state = np.random.RandomState(1)
    n_samples = 2
    ...
    expected_result = np.array([[[1.62434536, 0.38824359],
...
def test_random_generator() -> None:
    ...
    expected_result = np.array([[[0.34558419],
                                 [0.51080273],
                                 [-0.14077589],
                                 [0.31190205],
                                 [0.53508933]],
