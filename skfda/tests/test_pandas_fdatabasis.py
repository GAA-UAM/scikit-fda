...
from typing import Any, Callable, Iterable, NoReturn, Sequence  # noqa: UP035
...
def basis(request: Any) -> Any:  # noqa: ANN401
...
def all_data(request: Any, data: Any, data_missing: Any) -> Any:  # noqa: ANN401
    """Parametrized fixture giving 'data' and 'data_missing'"""  # noqa: D415
...
def na_cmp() -> Callable[[Any, Any], bool]:
    ...
    """  # noqa: D205, D415
    def isna(x: Any, y: Any) -> bool:  # noqa: ANN401
        return (
...
def na_value() -> pandas.NA:
    """The scalar missing value for this type. Default 'None'"""  # noqa: D415
    return pandas.NA
...
def box_in_series(request: Any) -> Any:  # noqa: ANN401
    """Whether to box the data in a Series"""  # noqa: D415
    return request.param
...
class TestDtype(base.BaseDtypeTests):  # type: ignore[misc]  # noqa: D101
    ...
    # Tries to construct dtype from string
    @pytest.mark.skip(reason="Unsupported")
    def test_construct_from_string(self, dtype: Any) -> None:  # noqa: ANN401, D102
        pass
...
class TestInterface(base.BaseInterfaceTests):  # type: ignore[misc]  # noqa: D101
    ...
    @pytest.mark.skip(reason="Unsupported")
    def test_copy(self, dtype: Any) -> None:  # noqa: ANN401, D102
        pass

    # We do not implement setitem
    @pytest.mark.skip(reason="Unsupported")
    def test_view(self, dtype: Any) -> None:  # noqa: ANN401, D102
        pass

    # Pending https://github.com/pandas-dev/pandas/issues/38812 resolution
    @pytest.mark.skip(reason="Bugged")
    def test_contains(self, data: Any, data_missing: Any) -> None:  # noqa: ANN401, D102
        pass
...
class TestArithmeticOps(base.BaseArithmeticOpsTests):  # type: ignore[misc]  # noqa: D101
    ...
    def test_arith_frame_with_scalar(  # noqa: D102
        ...
        all_arithmetic_operators: Any,  # noqa: ANN401
    ) -> None:
        pass

    # FDatabasis does not implement division by non constant
    @pytest.mark.skip(reason="Unsupported")
    def test_divmod_series_array(self, dtype: Any) -> None:  # noqa: ANN401, D102
        pass

    # Does not convert properly a list of FData to a FData
    @pytest.mark.skip(reason="Unsupported")
    def test_arith_series_with_array(self, dtype: Any) -> None:  # noqa: ANN401, D102
        pass

    # Does not error on operations
    @pytest.mark.skip(reason="Unsupported")
    def test_error(self, dtype: Any) -> None:  # noqa: ANN401, D102
        pass
...
class TestComparisonOps(base.BaseComparisonOpsTests):  # type: ignore[misc]  # noqa: D101
    ...
    def test_compare_scalar(  # noqa: D102
        self,
        data: Any,  # noqa: ANN401
        all_compare_operators: Any,  # noqa: ANN401
    ) -> None:
        pass
