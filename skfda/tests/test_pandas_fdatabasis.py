"""Tests for Pandas ExtensionArray for FDataBasis."""
...
def basis(request: pytest.FixtureRequest) -> Basis:
    """A fixture providing the ExtensionDtype to validate."""
    return request.param


@pytest.fixture
def dtype(basis: Basis) -> ExtensionDtype:
    """A fixture providing the ExtensionDtype to validate."""
    return FDataBasisDType(basis=basis)


@pytest.fixture
def data(basis: Basis) -> ExtensionArray:
    """
    Return data.
    ...
    * data[0] and data[1] should not be equal
    ...
    """
    coef_matrix = np.arange(10 * basis.n_basis).reshape(10, basis.n_basis)
...
@pytest.fixture
def data_missing(basis: Basis) -> ExtensionArray:
...
def na_cmp() -> Callable[..., bool]:
    ...
    """
    def isna(
        x: pd.api.typing.NAType | FDataBasis,
        y: pd.api.typing.NAType | FDataBasis,
    ) -> bool:
        return (
...
@pytest.fixture(
    params=list[Callable[[FDataBasis], Any]]([
