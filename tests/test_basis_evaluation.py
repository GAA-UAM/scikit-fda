...
class TestBasisEvaluationFourier(unittest.TestCase):
    ...
    def test_evaluation_keepdims_fourier(self):
        ...
        res = np.array([0.905482867989282, 0.146814813180645,
                        -1.04995054116993, 0.905482867989282,
                        0.302725561229459, 0.774764356993855,
                        -1.02414754822331, 0.302725561229459]
                       ).reshape((2, 4)).round(3)
    ...
    def test_evaluation_composed_keepdims_fourier(self):
        ...
        # Case default behaviour keepdims=True
        np.testing.assert_array_almost_equal(f_keepdims(
            t, aligned_evaluation=False).round(3), res_keepdims)
        np.testing.assert_array_almost_equal(
...
class TestBasisEvaluationMonomial(unittest.TestCase):
    ...
    def test_evaluation_simple_monomial(self):
        ...
        # Results in R package fda
        res = np.array([[1.00, 1.56, 2.66, 4.79, 8.62, 15.00,
