...
from skfda.preprocessing.dim_reduction.feature_extraction._per_class_feature_transformer import PerClassFeatureTransformer
...
class TestPCFT(unittest.TestCase):
    ...
    def test_transform(self): 
        ...
        for cur_class in range(classes.size):
            feature_transformer = RecursiveMaximaHunting().fit(X[y_ind == cur_class], y[y_ind == cur_class])
